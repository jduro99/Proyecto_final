...
def predecir_finanzas(datos):
    ...
    # Hacer la predicción
    prediccion = model.predict([[income, age, dependents, occupation, city_tier, rent, loan_repayment, disposable_income, gasto_fijo, gastos_variables]])
    
    return {"Results": [prediccion]} # Devuelve la predicción